...
router.get('/aboutUs(.html)?', (req, res) => {
    res.sendFile(path.join(__dirname, '..','frontend','HomePage','aboutUs.html'));
});

router.get('/blog(.html)?', (req, res) => {
    res.sendFile(path.join(__dirname, '..','frontend','HomePage','blog.html'));
});

router.get('/cafToken(.html)?', (req, res) => {
    res.sendFile(path.join(__dirname, '..','frontend','HomePage','cafToken.html'));
});

router.get('/contactUs(.html)?', (req, res) => {
    res.sendFile(path.join(__dirname, '..','frontend','HomePage','contactUs.html'));
});
